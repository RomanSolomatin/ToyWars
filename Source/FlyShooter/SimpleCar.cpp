...
const FName ASimpleCar::LookUpBinding("LookUp");
const FName ASimpleCar::LookRightBinding("LookRight");

#define LOCTEXT_NAMESPACE "VehiclePawn"


ASimpleCar::ASimpleCar(const FObjectInitializer& ObjectInitializer)
...
void ASimpleCar::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAction("Handbrake", IE_Pressed, this, &ASimpleCar::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &ASimpleCar::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ASimpleCar::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ASimpleCar::OnResetVR);
}
...
void ASimpleCar::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ASimpleCar::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ASimpleCar::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ASimpleCar::EnableIncarView(const bool bState, const bool bForce)
{
...
void ASimpleCar::Tick(float Delta)
{
...
void ASimpleCar::OnResetVR()
{
}

void ASimpleCar::UpdateHUDStrings()
{
...
float ASimpleCar::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, class AActor* DamageCauser)
{
