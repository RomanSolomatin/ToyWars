...
#include "MGTower.generated.h"

UCLASS()
class FLYSHOOTER_API AMGTower : public APawn
{
	GENERATED_BODY()
	...
	/** StaticMesh component that will be the visuals for our tower pawn */
	UPROPERTY(Category = Mesh, VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	class UStaticMeshComponent* TowerCannons;
...
public:
	...
	AMGTower(const FObjectInitializer& ObjectInitializer);
